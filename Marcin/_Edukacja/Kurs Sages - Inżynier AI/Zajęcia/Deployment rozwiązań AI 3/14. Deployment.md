...
 jest też parametr `progressDeadlineSeconds` Czyli ten maksymalny czas  W jakim jakiś postcem musi być  zanotowany w trakcie aktualizacji,  czyli Innymi słowy wracając do naszego przykładu gdybyśmy poczekali 10 minut na to żeby ten nasz deployment dostawił nowe pody,  To po 10 minutach po prostu dostajemy status odpowiedni i one wtedy były widoczny w zakładce work Cloud że nasz triployment przekroczył ten progresję dać Seconds i po prostu zatrzymałby się, nie próbowałby aktualizować nowe Pody. 
