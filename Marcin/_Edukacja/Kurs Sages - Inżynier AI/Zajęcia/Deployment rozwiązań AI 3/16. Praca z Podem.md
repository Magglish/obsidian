...
Ostatnia rzecz jaką chciałem już omówić to to że jak wejść do Poda. Tak jak wcześniej na zajęcia z kontenera używaliśmy komendy `exec`  tak samo tutaj Mamy też `kubectl exec`:
