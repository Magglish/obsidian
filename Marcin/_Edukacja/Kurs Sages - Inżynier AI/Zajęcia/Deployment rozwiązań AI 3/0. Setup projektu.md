...
1. Sprawdźcie czy działa Wam kubectl poprzez wywołanie `kubectl --help` i tylko tyle. Dla osób korzystających z MacOS - prośba o [doinstalowanie kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl-macos/#install-with-homebrew-on-macos)
2. 
