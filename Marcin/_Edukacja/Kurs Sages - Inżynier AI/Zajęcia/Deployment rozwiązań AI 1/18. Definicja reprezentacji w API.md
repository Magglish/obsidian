...
Przykładamy takich query mogą być np.:
	...
	4. `/items?format=XML` - wyniki zwróć w XMLu
	5. Zatem w naszym przypadku `/predictions?response_type=decision` będą określać to w jakim type chcemy zobaczyć nasz
