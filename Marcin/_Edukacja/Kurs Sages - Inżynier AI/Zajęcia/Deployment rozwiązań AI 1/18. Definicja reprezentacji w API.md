...
Ten endpoint `predictions` zostawimy sobie, żebyście mogli mieć porównanie. Sprawa w tym przypadku jest bardzo prosta. Skopiujmy sobie ten end

1. Zacznijmy od decisions
