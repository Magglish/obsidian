...
I teraz na koniec - to jest moja rekomendacja, wynikająca z doświadczenia. Natomiast to jaką Wy wybierzecie - należy do Was. Dla własnego rozwoju możecie nawet raz to, raz to. Po to abyście poczuli na własnej skórze, które rozwiązanie bardziej Wam odpowiada od strony programistycznej ale róœ
