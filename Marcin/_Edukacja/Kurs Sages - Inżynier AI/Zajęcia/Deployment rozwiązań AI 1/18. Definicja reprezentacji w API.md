...
Teraz dlaczego ja osobiście nie rekomenduje tego podejścia? Ono jest atrakcyjne z naszego punktu widzenia, developerskiego, bo możemy mieć jeden endpoint, w którym zdefiniujemy sobie logikę wybierania funkcji z modeli w zależności od wartości w parametrze query
