...
1. Uproszczone odpytywanie: odpytuje już znacznie precyzyjniejszą reprezentację `Decisions`, `Probabilities`, `Risk Categories`, a nie ogólną `Predictions`, więc też j
