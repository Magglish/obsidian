...
1. Zacznijmy od tego aby nazwać nasz endpoint tak jak powinniśmy w przypadku tego rozwiązania i będzie to po prostu `predictions`.
...
Nasze ciało funkcji trzeba teraz odpowiednio zmodyfikować, aby móc obsłużyć te trzy rodzaje outputów.
