...
9. `Connection` - nagłówek mówiący o nawiązaniu połączenia z serwisem, do którego wysyłaliśmy żądanie. To jest już temat bardzo zaawansowany, dlatego, że w komunikacji pomiędzy dwoma serwerami w
