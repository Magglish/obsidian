...
Ale są też błędy, które mogą się pojawiać i ich pojawienie się jest zupełnie normalne. Wyobraźmy sobie sytuację, że z jakiegoś powodu nasze połączenie z Redisem zostało przerwane. No nie wiem.. dajmy na to że Redis przestał istnieć, albo nagle dostęp do niej przez sieć jest niemożliwy. Może ktoś namieszał coś w konfiguracji sieciowej i teraz już nie jest ona dostępna - powodów może być cała masa. Zasymulujmy sobie to zdarzenie dodając do naszego endpointa po prostu wywołanie zamknięcia połączenia:
