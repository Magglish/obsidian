...
1. Rzucanie wyjątkami oraz logowanie ich treści powinno być maksymalnie precyzyjne. Tak żebyście dokładnie wiedzieli co się zadziało w Waszym API. I na to składa się wiele czynników: 
	...
	Zatem zdefiniowanie swoich własnych błędów pozwala Wam na polepszenie jakości rzucanych wyjątków i ich treści - znacznie łatwiej jest 