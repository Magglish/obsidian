...
Praktycznie za pomocą tych trzech exception handlerów obsłużyliście wszystkie błędy w Waszym API i nie uniknie Wam nic. Ktoś z Was może zadać sobie pytanie, czy ten 