...
Pokaż np. `redis.exceptions`

1. właśnie ze względu na punkt 1-wszy który opowiedziałem oraz drugi taki, że można bardzo łatwo nimi zarządzać oraz je wyłapywać.
