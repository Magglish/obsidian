...
Dlaczego? Dlatego, że `from e` robi dwie rzeczy:
1. Uwzględnia Tra
...
1. Spróbujmy popsuć ścieżke w ładowaniu modelu -> jak widzicie dostaliśmy w logach ERROR wraz z całym tracebackiem. Zwróćcie uwagę na tra
