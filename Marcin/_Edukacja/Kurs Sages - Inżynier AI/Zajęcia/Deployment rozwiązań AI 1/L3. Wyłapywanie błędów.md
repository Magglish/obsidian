...
3. Natomiast trzeci exception handler, który obsługuje wyjątek `Exception` służy nam do tego abyśmy zabezpieczyli się przed błędami w naszym API, z którymi nigdy do tej pory się nie spotkaliśmy. 