...
3) I to że jest gdzieś indziej to jest 3 minus - gwarantuje Wam to, że po jakimś czasie zapomnicie o tym, że `logging.exception` trzeba dodać gdzie indziej. W dodatku jak coś jest tak rozwlekłe na dwa miejsca to też wam gwarantuje, że takie rozwiązanie jest naprawdę trudno utrzymać.