...
1. 2xx:
	...
	2. `201 Created` oraz `202 Accepted` - Rzadziej spotykane, ale spotykane. Spotkacie się z nimi w dwóch sytuacjach:
		...
		2. Druga sytuacja jest wtedy kiedy chcemy wykonać jakąś predykcję, która długo trwa, możemy tak zaprojektować serwis, że przyjmie on nasze żądanie, w tle uruchomi joba, który rozpocznie pracę, a w odpowiedzi od razu zwróci nam `202 Accepted` wraz znow
