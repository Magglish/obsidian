...
Pytanie jakie można sobie zadać - czy ja musze znać wszystkie te statusy? I które z tych statusów potrzebuje do stworzenia serwisu do modelu? Te najważniejsze warto zapamiętać, bo z nimi będzie spotykać się często