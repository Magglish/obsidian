...
Następnie te API musimy uruchomić w trybie Debugera - niestety jeżeli uruchomimy to z poziomu terminala, to uruchomi się taki ubogi pythonowy `pdb`, który jest kiepski. Jeżeli uruchomimy to z IDE to dostaniemy coś znacznie lepszego, więc w tym przypadku polecam kliknąć tę strzałke oprócż `if __name__ == "__main__":`
