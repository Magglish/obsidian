...
Krótko mówiąc: większość API projektowanego do MLi będzie miało przetwarzanie jednego requestu z jednym przypadkiem i to w zupełności wystarczy. Natomiast przetwarzanie batchowe jest już trudne i na pierwszy kontakt z implementacją API do modelu byłoby zbyt trudne.
