...
W Debugerze mam "Console" i mogę działać. W "Debugger" mam podgląd obiektów i tego z czego się składają. W ten sposób możemy otrzymać tą interaktywnośc jaka jest w Notebooku i podejrzeć to jak te API działa i co konkretne kroki robią
