...
**Pyt:** Co to jest? W momencie kiedy uruchamiasz skrypt Pythonowy z poziomu konsoli `python src/service/main.py` to Python ustawia zmienną globalną `__name__` na wartość `__m 