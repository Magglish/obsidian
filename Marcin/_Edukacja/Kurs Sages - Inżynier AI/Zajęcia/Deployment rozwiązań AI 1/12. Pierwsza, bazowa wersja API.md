...
Ale zanim przejdziemy dalej to jeszcze jedna rzecz - w Data Science będziecie przyzwyczajeni do Notebooków, które są interaktywne. Można sobie podejrzeć czym jest dany obiekt, manipulować nim itd. itd. Jest to bardzo fajne i wygodne. Tutaj natomiast tego nie ma. Pytanie powstaje jak można sobie ułatwić zadanie w projektowaniu API? J
