...
2. I dane zwrócone w formacie JSON, które metodą `.json()` sobie wyciągnąłem i jak widzicie w przypadku tej osoby decyzja jest `DECLINE` - czyli wniosek o kredyt zost
