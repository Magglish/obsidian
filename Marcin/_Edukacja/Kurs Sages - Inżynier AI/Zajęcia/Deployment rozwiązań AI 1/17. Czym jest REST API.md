...
13. Słówko "S" oznacza State, czyli stan. W architekturze REST zakładamy, że API jest bezstanowe. Co to oznacza? Można do tego podejść na dwa sposoby:
	1. API "zapomina Nas" - wysyłamy request, jest przetwarzany, otrzymujemy odpowiedź i koniec. API nie zapmiętuje Nas i requesty są od siebie niezależne i nie powinny mieć wpływa na siebie.
