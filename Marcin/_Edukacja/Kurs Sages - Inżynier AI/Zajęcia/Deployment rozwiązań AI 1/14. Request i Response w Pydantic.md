...
9. Zresetujmy API już normalnie i zobaczmy co się zmieniło. Wykonajmy requesta z jednym polem więcej - i okazuje się, że dodatkowe pola nie są dozwolone. Można się teraz zapytać po co to zrobiliśmy? API działało poprawnie bez tego parametru. 