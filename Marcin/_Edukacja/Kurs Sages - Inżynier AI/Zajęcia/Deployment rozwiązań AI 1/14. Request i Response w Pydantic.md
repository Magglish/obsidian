...
8. Wróćmy do naszego `PredictRequest` w `requests.py` i zdefiniujmy go sobie. Pydantic pozwala nam konfigurować nasze klasy poprzez zdefiniowanie wewnątrz nich takiej e