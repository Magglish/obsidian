...
Następnie stwórzmy klase PredictionRequest, która dziedziczy po tym obiekcie.
...
I teraz bardzo fajna rzecz - wejdźmy sobie na dokumentację naszego API -> http://0.0.0.0:8080/docs i zobaczmy co mamy. Otrzymaliśmy szereg informacji na temat tego co może wejść do API i jaki jest z niego output z przykładowymi wartościami.