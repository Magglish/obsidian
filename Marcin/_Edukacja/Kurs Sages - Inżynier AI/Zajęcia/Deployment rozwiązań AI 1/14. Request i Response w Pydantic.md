...
Tak jak się można spodziewać, nasze żądanie zostało sparsowane tak jak określiliśmy to w naszych type hintach. Widzimy, że `foreign_worker`, `present_employment_since`, `personal_status_and_sex` są teraz typem Enum, a nie stringiem. Problem jaki możecie napotkać w tym rozwiązaniu jest następują
