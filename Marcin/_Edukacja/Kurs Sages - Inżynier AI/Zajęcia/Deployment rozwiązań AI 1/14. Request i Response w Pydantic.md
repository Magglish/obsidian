...
2. Zmieńmy `personal_status_and_sex` na wartość `male: married` i zobaczmy co otrzymamy. Dostajemy informacje, że nasza wartość jest złą wartością, nie wchodząca w skłąd Enuma i w dodatku 