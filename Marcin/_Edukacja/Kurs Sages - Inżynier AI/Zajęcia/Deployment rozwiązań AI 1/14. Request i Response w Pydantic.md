...
1. `age` podobnie jak `installment_rate_in_percentage_of_disposable_income` ale tutaj ustalmy, że minimalnym wiekiem będzie 18, czyli osoba dorosła i maksymalnie niech będzie 100.