...
3. I ostatnie dwa parametry, które są dla nas bardzo istotne w kontekście tej zmiennej czyli `ge`, czyli greater or equal than - w naszym przypadku to bedzie wartosc 0.0. Ktoś może być 
