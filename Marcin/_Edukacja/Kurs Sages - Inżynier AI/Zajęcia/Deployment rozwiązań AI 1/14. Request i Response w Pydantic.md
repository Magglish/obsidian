...
3. W dodatku zobaczcie pojawiły się też możliwe wartości jakie można przekazać do zmiennych numerycznych `installment_rate_in_percentage_of_disposable_income` oraz `age_in_`