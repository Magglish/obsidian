...
Zanim przejdziemy dalej to jeszcze zrefactorujemy sobie nasz endpoint `predict_decision` bo ten kod w środku który jest jest brzydki. Lepiej bedzie jak logika zamiany na pandasowy dataframe będzie wprost zdefiniowany w obiekcie PredictRequest