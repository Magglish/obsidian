...
3. (Dodatkowe) Jeśli ktoś z Was ma więcej czasu, to może przyjrzeć się FastAPI, w którym będziemy pracować na zajęciach (https://fastapi.tiangolo.com/tutorial/) oraz kierować się tym tutorialem, aby zapoznać się - dzięki temu łatwiej będzie przyswoić wiedzę na zajęciach :) 
