...
6. Powyższe case dotyczą sytuacji, w których modyfikujemy requesta lub robimy coś na bazie danych z requesta. Nic nie stoi na przeszkodzie aby zaimplementować Middleware, który bezpośrednio zmienia naszego response - to jest z pewnością rzadzie spotykane, ale jakn jab
