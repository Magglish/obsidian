...
I po lewej stronie uruchamiamy `Debug 'main'`, ale zanim to zrobimy to upewnijmy się w `Modify run configuration`, że ścieżki są prawidłowo ustawione na:

`/home/marcin/PycharmProjects/inzynierai-api-wip/`
