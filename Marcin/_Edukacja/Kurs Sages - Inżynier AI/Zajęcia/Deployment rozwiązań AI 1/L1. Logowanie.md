...
Wróćmy sobie do `correlation.py` i wróćmy sobie do tego `CORRELATION_ID`. Ta zmienna globalna została zdefiniowana za pomocą takiego obiektu jak `ContextVar`. Teraz dlaczego tak jest. 
