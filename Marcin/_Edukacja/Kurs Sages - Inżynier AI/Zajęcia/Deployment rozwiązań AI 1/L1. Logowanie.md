...
1. Ta implementacja jest bardzo prosta - mozna samemu ja zrobic zamiast dodawać dodatkowe zależności. Pamiętajcie, że każda dodatkowa zależność oznaczać może większy problem na produkcji - FastAPI albo Starlette się zmieni, ale czy razem z nowymi zmianami tutaj też będą te zmiany? No nie
