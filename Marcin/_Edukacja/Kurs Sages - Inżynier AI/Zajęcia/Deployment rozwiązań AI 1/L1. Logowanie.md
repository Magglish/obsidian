...
Powodów jest wiele:
Odp: 
1. Formatowanie będzie kiepskie - np. logging.exception 
2. Do logowania możesz dostarczyć metadane - których do printa nie dostarczych
3. Biblioteki do logowania pozwolą Ci na stworzenie struktury - np. JSON, który później łatwiej jest 
4. Printy piszą do XXX i nie zawsze może być obsłużone 
