...
5. Natomiast co jest fajne w tej bibliotece, to to, że w momencie rzucenia błędów on również raportuje co znajduje się w zmiennej `locals()`, czyli dostajecie informacje o wartościa
