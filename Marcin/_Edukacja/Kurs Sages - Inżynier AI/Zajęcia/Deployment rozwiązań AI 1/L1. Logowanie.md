...
3. `WARNING` -  poziom wyżej niż INFO, który informuje, że coś się zadziało w aplikacji co może nie do końca było spodziewane, albo spodziewamy się, że coś się może wydarzyć - w naszym mozna by było zro 
4. `ERROR` - 
5. `CRITICAL` - 
