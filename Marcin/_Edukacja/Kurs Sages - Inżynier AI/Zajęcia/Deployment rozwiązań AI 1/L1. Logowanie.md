...
Żeby to zrozumieć to musimy zacząc od końca. Chciałbym żebyśmy spojrzeli sobie na `src.utils.logging.` Tam jest taka funkcja jak `setup_logging_with_correlation_id`. Biblioteki do logowania pozwalają Wam na definiowanie tego jak Wasze logi powinny wyglądać. Spójrzmy na to jak jest zdefiniowany formatter:
...
Dzięki tej implementacji, my z tego `correlation_id` możemy skorzystać w naszych Formatterach
