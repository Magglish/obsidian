...
2. Oraz na końcu wywołania funkcji - aby mieć informację zwrotną, że faktycznie funkcja zakończyła się. Z logowaniem na końcu funkcji jest jeszcze jedna istotna właściwość - oznacza to, że funkcja wykona
