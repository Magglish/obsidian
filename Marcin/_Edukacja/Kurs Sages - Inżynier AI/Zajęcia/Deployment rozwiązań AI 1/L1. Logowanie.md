...
Widzimy, że mamy teraz dodatkowe informacje o czasie logów oraz o ich poziomie - w tym przypadku jest to INFO, bo skorzystaliśmy z `logging.info`. Wykonajmy request i zobaczmy teraz logi z działania endpointa. No teraz to już zdecydowanie lepiej wygląda i możemy analizować historię tego co się zadziało w naszym endpoincie.

Jest sporo metadanych jakie możemy dodać i to już wynika
