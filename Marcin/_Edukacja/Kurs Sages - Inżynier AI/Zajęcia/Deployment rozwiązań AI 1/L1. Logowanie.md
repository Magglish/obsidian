...
2. `INFO` - podstawowy poziom informujący o zdarzeniu/stanie naszej aplikacji - tak jak tutaj używaliśmy aby przekazać informacje, że rozpoczęło się przetwarzanie funkcji
3. `WARNING` -  
4. `ERROR` - 
5. `CRITICAL` - 
