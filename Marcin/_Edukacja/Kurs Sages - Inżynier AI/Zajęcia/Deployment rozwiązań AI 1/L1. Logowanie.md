...
2. Ważne jest dodanie dwóch najważniejszych metadanych do waszych logów:
	...
	2. oraz używanie odpowiednich poziomów, DEBUG, INFO, WARNING, ERROR, CRITICAL - to Wam pozwoli na przede pogrupowanie logów i ich łatwiejszą analizę no i to co przedchwilą powiedziałem - te poziomu logów również są używane do określ
