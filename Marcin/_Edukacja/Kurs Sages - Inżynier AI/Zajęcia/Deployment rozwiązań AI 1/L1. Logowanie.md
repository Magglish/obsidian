...
To co widać na zdjęciu to treść błędu z jednego z naszych serwisów działających na produkcji na chmurze Google'a, która jak widizci brzmi: "There was a problem openin a stream. Try turning on DEBUG level logs to see the error".
