...
Pierwszy błąd powinien być związany z połączeniem z Redisem. Dobra to teraz stwórzmy go `make redis`. Spróbujmy jeszcze raz. Teraz wywaliło się na `Postgresie`. A teraz powinno zadziałać. Dobra, to było szybkie sprawdzenie czy faktycznie nasze logowanie zadziałało. Natomiast jest jeden problem... j
