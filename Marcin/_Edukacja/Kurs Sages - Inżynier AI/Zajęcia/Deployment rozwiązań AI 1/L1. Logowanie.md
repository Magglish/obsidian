...
Włączmy API, wyślijmy requesta i zobaczmy efekt. Mamy to :) Zobaczcie, każdy log który widzicie, został odpowiednio oznaczony tym unikalnym ID, który został stworzony w Middlewarze i teraz bez problemu 

Pytanie do Was, czy do tej pory jest to jasne?
