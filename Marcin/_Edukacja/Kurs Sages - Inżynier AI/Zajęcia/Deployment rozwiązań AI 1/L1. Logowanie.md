...
3. lub nawet pójść w bardziej ekstremalne rozwiązanie i logować wszystko dopiero od poziomu WARNING wzwyż - z czym też możecie się spotkać: argument za tym jest prosty: jeżeli wszystko działa poprawnie, czyli czytaj: nie rzucane są warningi, errory i criticale - to po co w ogóle patrzyć w logi? 
