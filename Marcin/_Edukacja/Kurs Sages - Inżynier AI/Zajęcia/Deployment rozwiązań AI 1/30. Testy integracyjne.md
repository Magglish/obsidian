...
Teraz może troszkę wyjaśnienia ja w swoim implementacji RedisClienta zawarłem już kody które przekształcają wynik z Postgresa ze zwykłych słowników na trzy obiekty - Wiersz zawiera w sobie `metadata` oraz dane  o `request` oraz `response`.
