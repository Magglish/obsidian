...
```
   ...
   1. Możemy zamienić nasz obiekt request na str poprzez `str(request)` i wrzucić go do bazy `client.set(str(request), 1)` i jak widzicie dostajemy `True` udało się. 
