...
Mamy teraz trzy requesty: `decision_request`, `risk_category_request` oraz `probability_request`. Czyli można to zinterpretować tak, że ktoś nasze API odpytał 3 razy, za każdym razem inny endpoint, ale z tymi samymi danymi wejściowymi.
