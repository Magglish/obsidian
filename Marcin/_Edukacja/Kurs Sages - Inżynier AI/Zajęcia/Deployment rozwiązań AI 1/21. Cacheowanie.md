...
Zastanawiałem się nad tym długo i po zapoznaniu się z dokumentacją jak działa Redis podspodem to wniosek jest taki: Redis ma pod sobą swoje własne mechanizmy przechowywania danych w sposób dla niego optymalny. My możemy postarać się mu pomóc w tym troche wybierając format, który teoretycznie jest najmniejszy, ale nie zawsze gwarantuje to sukces. Z mojego punktu widzenia i doświadczenia 
