...
Dlatego kiedy będziecie definiować BackgroundTaski to powinna zapalić wam się czerkorzystając z `async def` musicie zastanowić się czy operacje, które są w nim mogą być przetwarzane w sposób asynchroniczny. Zaraz Wam powiem co to znaczy.
