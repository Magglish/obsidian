...
Z kolei konsola tutaj z analizą procesów i wątków mówi nam właśnie że powstało kilka wątków. I one są w cudzysłowiu równoległe przetwarzane, bo tak w przeciwności nie jest jak widzicie cały czas ten interpreter realizuje inny wątek. Ale jak widać są cztery wątki czyli nasze cztery questy są przetwarzane.
