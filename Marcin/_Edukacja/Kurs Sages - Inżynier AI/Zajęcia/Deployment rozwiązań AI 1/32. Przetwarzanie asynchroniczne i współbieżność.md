...
Żeby kod działał asynchronicznie, to musimy już skorzystać z implementacji, które w taki sposób zostały stworzone. Generalnie rzecz biorąc biblioteki np. z zapisywaniem danych do bazy danych mogą mieć u 
