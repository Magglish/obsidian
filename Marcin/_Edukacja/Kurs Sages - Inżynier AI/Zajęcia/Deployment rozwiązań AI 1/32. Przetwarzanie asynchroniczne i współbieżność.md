...
Teraz chciałbym **zasymulować**, podkreślam **zasymulować** że mamy w środku jakiś kod który działą w sposób asynchroniczny.

Pr sobie do implementacji naszego redisa do `BaseRedisClient` I teraz żeby coś było przetwarzane w sposób asynchroniczny musimy wykonać dwie rzeczy.
