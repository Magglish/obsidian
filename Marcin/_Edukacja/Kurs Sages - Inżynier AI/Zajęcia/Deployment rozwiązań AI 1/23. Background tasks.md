...
Zobaczcie: nie dostałem odpowiedzi od razu, a w logach API jest info, że zwracamy odpowiedź. Odpale kolejny terminal i wysle zapytanie - wiszą. I czekają aż skończy się background tasks. A logi FastAPI mówią co innego.