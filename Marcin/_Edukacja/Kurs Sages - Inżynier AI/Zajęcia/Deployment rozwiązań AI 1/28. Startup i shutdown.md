...
W ten sposób otrzymujemy wszystkie procesy które działają w naszym systemie i wśród nich musimy odnaleźć gdzie jest nasze API. Najłatwiej będzie to zrobić po prostu szukając w tej liście naszego skryptu Czyli przekażemy wynik tej komendy dalej do funkcji krep i spróbujmy znaleźć  Python SRC Service main.
