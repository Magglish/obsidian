...
4) No i teraz pytanie powstaje - co powinniśmy użyć w kontekście naszego API? POST czy GET? Na razie pytanie pozostawiam bez odpowiedzi, później do tego zagadnienia wrócimy jak zdobędziemy troche więcej wiedzy, ale zaspoileruje, że chodzi po prostu o pewne zdefiniowane zasady w projektowaniu REST API i związanym z tym best practises. 