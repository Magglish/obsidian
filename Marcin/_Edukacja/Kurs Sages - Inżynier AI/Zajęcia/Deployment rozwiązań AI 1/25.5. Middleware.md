...
FastAPI ma dostępne kilka Middleware [ale jest ich bardzo mało](https://fastapi.tiangolo.com/advanced/middleware/). Jest też wiele pluginów do FastAPI, które [zapewniają różne middleware'y](https://github.com/florimondmanca/awesome-asgi) weź CTRL + F i wyszukaj Middle.
