...
Jak się sami dzisiaj przekonacie, pisanie kodu i skryptów do budowy kontenerów będzie krótkie, w porównaniu do tego co można napisać przy budowie API. Ale sami się przeknatomiast każda linijka kogo będzie miała bardzo duże znaczenie.
