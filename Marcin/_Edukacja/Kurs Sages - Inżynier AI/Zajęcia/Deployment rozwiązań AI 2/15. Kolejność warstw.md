...
Teraz to wynika z tego że działania Dockera jest następujący sposób: Jeżeli pojawiła się nowa warstwa,  w tym przypadku pojawiła się nowa zmienna środowiskowa,  albo zostały dokonane jakieś zmiany w warstwie która już istniała -  czyli na przykład zmieniły się jakieś pliki bądź zmieniła się instrukcja, To doker jest w stanie to o czymś rozpoznać dlatego że  sumy kontrolne mu się nie zgadzają.  i w takiej sytuacji docker robi tak że wszystkie warstwy które znajdują się pod warstwą dla której suma kontrolna jest inna,  czyli zaszły jakieś zmiany bądź pojawiła się nowa warstwa,  po prostu będą odtwarzane na nowo,  czyli te instrukcje zostaną wykonane ponownie a nie pobrane z Kesha. 
